...
public class SignUp_page extends AppCompatActivity {
   ...
   // private Button btn_clear;
    private EditText ed_name,ed_userName,ed_email,ed_pass;
   ...
   //    btn_clear=(Button) findViewById(R.id.btn_clear);
        ...
        btn_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final String userfname = ed_name.getText().toString().trim();
                ...
                try {
                    userRegistering(userfname,username,useremail,userpass);
                }catch (Exception e){
  ...
  /*  public void clear(){
    ...
    private void userRegistering(String userfname, String username, String useremail, String userpass){
        progressDialog.show();
        login_Auth.createUserWithEmailAndPassword(useremail,userpass). addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    Toast.makeText(SignUp_page.this, "Congratulations! Your Registration is successful", Toast.LENGTH_SHORT).show();
